...
class Editor
{
    ...
    public function editor_assets()
    {
        ...
        AssetVite::get_instance()->enqueue_asset('assets/integration/bricks/main.js', ['handle' => $handle, 'in_footer' => \true]);
        \wp_localize_script($handle, 'windpressbricks', ['_version' => WIND_PRESS::VERSION, 'assets' => ['url' => AssetVite::asset_base_url()], 'site_meta' => ['name' => \get_bloginfo('name'), 'site_url' => \get_site_url(), 'admin_url' => AdminPage::get_page_url()]]);
