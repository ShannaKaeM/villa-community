...
class Main implements IntegrationInterface
{
    ...
    {
        return (bool) \apply_filters('f!windpress/integration/oxygen:enabled', Config::get(\sprintf('integration.%s.enabled', $this->get_name()), \true));
    }
    public function register_provider(array $providers) : array
    {
        $providers[] = ['id' => $this->get_name(), 'name' => \__('Oxygen Builder', 'windpress'), 'description' => \__('Oxygen Builder integration', 'windpress'), 'callback' => \WindPress\WindPress\Integration\Oxygen\Compile::class, 'enabled' => $this->is_enabled()];
        return $providers;
    }
