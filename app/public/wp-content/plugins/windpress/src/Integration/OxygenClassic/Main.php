...
class Main implements IntegrationInterface
{
    public function __construct()
    {
        ...
        if ($this->is_enabled()) {
            ...
            new \WindPress\WindPress\Integration\OxygenClassic\Editor();
            new \WindPress\WindPress\Integration\OxygenClassic\Front();
        }
    }
    ...
    {
        return (bool) \apply_filters('f!windpress/integration/oxygen-classic:enabled', Config::get(\sprintf('integration.%s.enabled', $this->get_name()), \true));
    }
    public function register_provider(array $providers) : array
    {
        $providers[] = ['id' => $this->get_name(), 'name' => \__('Oxygen Classic Builder', 'windpress'), 'description' => \__('Oxygen Classic Builder integration', 'windpress'), 'callback' => \WindPress\WindPress\Integration\OxygenClassic\Compile::class, 'enabled' => $this->is_enabled()];
        return $providers;
    }
