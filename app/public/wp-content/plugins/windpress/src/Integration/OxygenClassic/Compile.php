...
class Compile
{
    private array $ignored_post_types = ['attachment', 'revision', 'nav_menu_item', 'custom_css', 'customize_changeset', 'oembed_cache'];
    private array $post_meta_keys = ['ct_builder_shortcodes', 'ct_builder_json'];
