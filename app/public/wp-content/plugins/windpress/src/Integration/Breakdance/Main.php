...
class Main implements IntegrationInterface
{
    public function __construct()
    {
        ...
        if ($this->is_enabled()) {
            ...
            new \WindPress\WindPress\Integration\Breakdance\Editor();
        }
    }
    ...
    {
        return (bool) \apply_filters('f!windpress/integration/breakdance:enabled', Config::get(\sprintf('integration.%s.enabled', $this->get_name()), \true));
    }
    public function register_provider(array $providers) : array
    {
        $providers[] = ['id' => $this->get_name(), 'name' => \__('Breakdance Builder', 'windpress'), 'description' => \__('Breakdance Builder integration', 'windpress'), 'callback' => \WindPress\WindPress\Integration\Breakdance\Compile::class, 'enabled' => $this->is_enabled()];
        return $providers;
    }
